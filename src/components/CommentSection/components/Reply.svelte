...
<div class="grid grid-cols-1 gap-4">
  <div class="grid grid-cols-2 gap-4">
    <div class="px-1">
      ...
      <input
        name="nickname"
        class="w-full p-2 text-sm bg-gray-200 px-4 font-bold border border-black/15 rounded transition-colors duration-300 ease-in-out hover:bg-black/5 hover:text-black dark:bg-transparent dark:border-white/20 dark:hover:bg-white/5 dark:hover:text-white"
        type="text"
        title={t('nickname')}
        bind:value={nickname}
      />
  ...
  <div class="px-1">
    <button
      ...
      class="text-sm bg-gray-200 p-2 px-4 font-bold border border-black/15 rounded transition-colors duration-300 ease-in-out hover:bg-black/5 hover:text-black dark:bg-transparent dark:border-white/20 dark:hover:bg-white/5 dark:hover:text-white"
